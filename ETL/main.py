...
# ==========================================
# En Cloud Run, configuraremos DATABASE_URL como variable de entorno secreta.
...
if __name__ == "__main__":
    ...
    # En Cloud Run usamos /tmp para evitar problemas de permisos de escritura
    directorio_trabajo = "/tmp" if os.environ.get("K_SERVICE") else "."
    archivo_local_excel = os.path.join(directorio_trabajo, "obras_publicas.xlsx")
